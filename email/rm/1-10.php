<div class="row">
    ...
    <div class="col-md-9" id="embody" style="border-left: solid;">
		...
		if($_GET['set'] == "on"){
			...
			<!-- Email Temaplate -->
			<p>
				<strong>Subject:</strong> <?php echo ucfirst($brwName);?>, we missed your 2-day window
			</p>
			<br>
			...
			<p>Thanks for contacting me. As a reminder, we need at least 2 business days to make payment changes. That means I won’t be able to adjust your payment of $<?php echo number_format($pmtAmt,2,".",","); ?> that's due on <?php echo date_format($pmtdate,"l, F jS"); ?>.
			</p>
