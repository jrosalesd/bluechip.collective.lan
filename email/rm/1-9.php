<div class="row">
	<div class="col-md-3">
		...
		<font color="red">
			<h5>
				<b>Template Usage: </b>Use this template when a borrower confirms they want to defer their payment.
				<br>
			</h5>
		</font>
	</div>
	<div class="col-md-9" style="border-left: solid;">
		...
		if($_GET['set'] == "on"){
		    ...
		    <?php echo definterest(1,$_GET['pmtdate'], $_GET['pmtamt'], $_GET['defamt']);?>
