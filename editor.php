...
$auth_users = array(
    //'julior' => '21232f297a57a5a743894a0e4a801fc3', //admin
    ...
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        <div class="path login-form">
            ...
            <form action="" method="post">
                ...
                <input type="submit" value="Login"><button type="button" href="index.php"></button>
            </form>
        </div>
        <?php
...
<div class="path main-nav">
        ...
        <div class="break-word float-left">
            <a href="<?php if(isset($_GET['return'])) { echo $_GET['return']."&id=".$_GET['id'];}else{echo "index.php";}?>" alt="return"><i class="fa fa-times" ></i>Close</a>
            <?php echo $root_url;?>
        </div>
