<div class="row">
	<div class="col-md-3">
		...
		<font color="red">
			<h5>
				<b>Template Usage: </b>Use this template when a consumer requests their confirmation number.
				<br>
			</h5>
		</font>
	</div>
	<div class="col-md-9" style="border-left: solid;">
		...
		if($_GET['set'] == "on"){
		    ...
		    <p>Please let me know if there is anything else that I can assist you with.</p>
