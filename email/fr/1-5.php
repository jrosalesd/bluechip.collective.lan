<div class="row">
    <div class="col-md-3">
		...
		<font color="red">
			<h5>
				<b>Template Usage: </b>Use this template when you are providing the custoemr withe 0% interest restructure offer for the full balance in a 5 month Period.
			</h5>
		</font>
    </div>
    <div class="col-md-9" id="embody" style="border-left: solid;">
		...
		if($_GET['set'] == "on"){
			...
			<p>
				As discussed, we’ve placed your account on an interest freeze to help you pay off your Spotloan. You’re all set to make a payment of $<?php echo $pmtamt;?> from your bank account on file. This payment will be debited on <?php echo date_format($pmtdate,"l, F jS");?>. 	
			</p>
				
			<p>
				Below is the current payment schedule for your loan, so you know exactly what to expect. Please review the payment schedule closely, as it may have changed due to recent loan activity, like missing a payment, deferring a payment, making a partial payment, or making any extra payments. <b>This payment schedule supersedes and replaces any earlier payment schedule(s) provided for your loan.</b>
			</p>
			...
			<p>
				Please note that if any payments return for any reason, you will no longer be qualified for this discount and your original interest rate. This means that this discount offered to you will be void and collection efforts will remain on your account toward your full balance with interest.
				</p>
			<p>
