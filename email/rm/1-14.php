<div class="row">
    ...
    <div class="col-md-9" id="embody" style="border-left: solid;">
		...
		if($_GET['set'] == "on"){
			...
			<p>
				I sent you a payment confirmation email two days ago. Unfortunately, <?php echo $bankname;?> just told me that your payment of $<?php echo number_format($pmtAmt,2,".",","); ?> on <?php echo date_format($pmtdate,"l, F jS"); ?>, didn’t go through because <?php echo $return;?>. This means that the payment confirmation you received is incorrect.
			</p>
			<p>
